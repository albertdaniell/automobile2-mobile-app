...
this.setState({
    ...
    render() {
        return (
            ...
            <Input onChange={this.searchFn} onSubmitEditing={this.searchFn} onChangeText={(searchCompQuery)=>this.setState({searchCompQuery})} placeholder="Search" on />
